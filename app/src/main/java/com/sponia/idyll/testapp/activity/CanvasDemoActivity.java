...
import com.sponia.idyll.testapp.view.DrawLineView;

import java.text.NumberFormat;

/**
 * @author shibo
 * @packageName com.sponia.idyll.testapp.activity
 * @description
 * @date 15/12/25
 */
...
//            canvas.drawTextOnPath("Sponia ANDROID", path, 10, 10, paint);
            ...
            canvas.drawTextOnPath("http://www.sponia.com", path, 28, 0, citePaint);
            canvas.restore();
