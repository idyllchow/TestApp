...
/**
 * @author shibo
 * @packageName com.idyll.testapp.view
 * @description
 * @date 16/1/19
 */
@SuppressLint("NewApi")
public class DragGridView extends GridView{
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            LogUtil.defaultLog("onInterceptTouchEvent(), down");
        } else if (action == MotionEvent.ACTION_UP) {
            LogUtil.defaultLog("onInterceptTouchEvent(), up");
        }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch(ev.getAction()){
            case MotionEvent.ACTION_DOWN:
                LogUtil.defaultLog("----------------------");
                LogUtil.defaultLog("dispatchTouchEvent(), down");
                ...
                LogUtil.defaultLog("mDragPosition: " + mDragPosition);
...
//			LogUtil.defaultLog("dispatchTouchEvent(), move");
            ...
            case MotionEvent.ACTION_UP:
                LogUtil.defaultLog("dispatchTouchEvent(), up");
                mHandler.removeCallbacks(mLongClickRunnable);
...
//		LogUtil.defaultLog("isDrag: " + isDrag);
        if(isDrag && mDragImageView != null){
            switch(ev.getAction()){
                case MotionEvent.ACTION_DOWN:
                    LogUtil.defaultLog("onTouchEvent(), down");
                    break;
                case MotionEvent.ACTION_MOVE:
//				LogUtil.defaultLog("onTouchEvent(), move");
                    moveX = (int) ev.getX();
                    moveY = (int) ev.getY();
                    //拖动item
                    ...
                    break;
                case MotionEvent.ACTION_UP:
                    LogUtil.defaultLog("onTouchEvent(), up");
                    onStopDrag();
                    isDrag = false;
                    break;
            }
